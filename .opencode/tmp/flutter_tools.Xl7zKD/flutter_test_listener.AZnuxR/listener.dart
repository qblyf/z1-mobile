...
import 'file:///Users/fan/www/AI/phone/Flutter/z1-nextapp/z1_mobile/test/integration/auth_login_integration_test.dart' as test;

const packageConfigLocation = 'file:///Users/fan/www/AI/phone/Flutter/z1-nextapp/z1_mobile/.dart_tool/package_config.json';
...
void main() {
  ...
  StreamChannel<dynamic> testChannel = serializeSuite(() {
    catchIsolateErrors();
    goldenFileComparator = LocalFileComparator(Uri.parse('file:///Users/fan/www/AI/phone/Flutter/z1-nextapp/z1_mobile/test/integration/auth_login_integration_test.dart'));
